...
def main():
    ...
    with app.app_context():
        ...
        csv_files = [
            ('/home/ubuntu/upload/DENGBR25.csv', 'A90', 'Dengue'),
            ('/home/ubuntu/upload/CHIKBR25.csv', 'A920', 'Chikungunya'),
            ('/home/ubuntu/upload/COQUBR25.csv', 'A379', 'Coqueluche'),
            ('/home/ubuntu/upload/ROTABR25.csv', 'A080', 'Rotavírus'),
            ('/home/ubuntu/upload/ZIKABR25.csv', 'A928', 'Zika')
        ]
